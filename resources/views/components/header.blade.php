<header id="site-header" class="fixed top-0 left-0 right-0 z-50 transition-all duration-500">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 sm:h-20">
            ...
            <nav class="hidden lg:flex items-center gap-1">
                ...
                <a href="#tickets" class="nav-link px-4 py-2 text-ngemi-cream/60 hover:text-ngemi-orange transition-colors text-sm font-medium rounded-lg hover:bg-white/5">Tickets</a>
            ...
            <div class="flex items-center gap-3">
                <a href="#tickets" class="hidden sm:inline-flex bg-ngemi-orange hover:bg-ngemi-orange-dark text-ngemi-dark font-bold px-5 py-2.5 rounded-lg text-sm transition-all hover:shadow-lg hover:shadow-ngemi-orange/20 active:scale-95">
                    Get Tickets
                </a>
    ...
    <div id="mobile-menu" class="lg:hidden absolute top-full left-0 right-0 bg-ngemi-dark/98 backdrop-blur-xl border-b border-ngemi-orange/10 transform -translate-y-full opacity-0 pointer-events-none transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 py-6 space-y-1">
            ...
            <a href="#tickets" class="mobile-nav-link block px-4 py-3 text-ngemi-cream/60 hover:text-ngemi-orange hover:bg-ngemi-orange/5 rounded-lg text-base font-medium transition-all mobile-menu-link">Tickets</a>
